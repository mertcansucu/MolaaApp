...
namespace MolaaApp.Migrations
{
    ...
    [Migration("20240325023039_AddStartTimeHourToMeeting")]
    partial class AddStartTimeHourToMeeting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MolaaApp.Entity.Meeting", b =>
                {
                    ...
                    b.Property<TimeSpan>("StartTimeHour")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MolaaApp.Entity.Post", b =>
                {
                    b.Property<int>("PostId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MolaaApp.Entity.Comment", b =>
                {
                    b.HasOne("MolaaApp.Entity.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("PostTag", b =>
                {
                    b.HasOne("MolaaApp.Entity.Post", null)
                        .WithMany()
